...
# write.csv(bbb_both2, "NNTm1000_PROBIT_3_02.csv", row.names = F)
...
ggsave("NNT_3_02_PROBITm1000V1.jpeg")
...
ggsave("EIN_2_81_PROBITm1000V1.jpeg")
...
ggsave("NNE_3_41_PROBITm1000V1.jpeg")
