...
bbb_both2$NNT <- ifelse(bbb_both2$NNT < 1, NA, bbb_both2$NNT)
...
ggsave("NNT_4_65_LOGITm1000R1.jpeg")
...
ggsave("EIN_4_18_LOGITm1000R1.jpeg")
...
ggsave("NNE_5_60_LOGITm1000R1.jpeg")
