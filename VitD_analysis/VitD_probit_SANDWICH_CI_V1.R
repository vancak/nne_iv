...
# prevalence of filaggrin in unexposed
mean(Z[A == 0])
...
coef_bet <- coef(glm(I(1-death) ~ expose + filaggrin + I(expose*filaggrin), 
                     data   = VitD, 
...
# sample based estimation of the NNT
pb_new <- mean(
  ( pnorm(coef_bet[1] + coef_bet[2]*A + coef_bet[3]*Z + coef_bet[4]*A*Z + coef_psi[1]*(1 - A)) - 
