...
write.csv(bbb_both2, "NNTm1000_LOGIT_3_02.csv", row.names = F)
...
write.csv(bbb_both2, "EINm1000_PROBIT_2_81.csv", row.names = F)
...
write.csv(bbb_both2, "NNEm1000_PROBIT_3_41.csv", row.names = F)
